 ...
 */
var imgs=[
  {'i':0,'img':'image/pic-1.jpg'},
  {'i':1,'img':'image/pic-2.jpg'},
  {'i':2,'img':'image/pic-3.jpg'}
];
var adv={
    LIWIDTH:0,
    $ulImgs:null,
    ...
    timer:null,
    init(){
      this.LIWIDTH=parseFloat($(".banner-bg>#slider").css("width"));
      this.$ulImgs=$("#img");
      this.updateView();
      $("#index").on("mouseover","li",(e)=>{
        var target=$("#index>li").index(e.target);
        var old=imgs[0].i;
